...
public class TempStartGame2 {
	...
	// private Player player;
	 ...
	 public TempStartGame2(Main plugin) {
	        	...
	        	if(plugin.PlayerisArena(players)) {
		        	if(plugin.getArenaPlayerInfo().get(players).equals(name)) {
			       	     ...
			       	     if(join1.contains(players.getName())) {
						    		...
						    		players.sendTitle(""+ChatColor.RED+ChatColor.BOLD+String.valueOf(segundo),""+ChatColor.YELLOW+ChatColor.BOLD+"La partida empieza en ", 20, 20, 20);
					       	  		}
						    	...
						    	//	players.sendMessage(ChatColor.RED+"No hay jugadores suficientes para empezar la partida :(");
					    		    ...
					    		    players.sendMessage(ChatColor.YELLOW+"La partida empieza en "+ChatColor.RED+segundo);
					    		}
